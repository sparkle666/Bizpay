    ...
    return (
      <>
        ...
        <section className="bg-gray-100 p-8 text-black">
          ...
          <div className="mt-8 md:flex justify-between space-y-8 md:space-y-0 gap-12">
            <div className="flex-1 p-4 space-y-6 rounded-2xl bg-gray-200">
              <h2 className="font-semibold text-xl">Recent Payments</h2>
                ...
                <div key={index} className="flex justify-between">
                  <span className="flex gap-4">
                    ...
                    <span>
                      ...
                      <p className="text-[#111111]">{item.date}</p>
                    </span>
                  </span>
                  <p className="text-black py-3 font-semibold">{item.amount}</p>
                  <p
                    className={
                      item.status === "Done"
                        ? "rounded-xl font-semibold py-3 px-6 text-[#3BAA67] bg-[#DCFFD6]"
                        : "rounded-xl font-semibold py-3 px-6 text-[#937F59] bg-[#FFEDCB]"
                    }
                  >
                    {item.status}
                  </p>
